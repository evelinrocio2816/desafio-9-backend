...
class CartController {
    ...
    async updateProductsInCart(req, res) {
        ...
        try {
            ...
            console.log("Products updated in cart. Updated cart:", updatedCart);
    ...
    async updateQuantity(req, res) {
        ...
        try {
            ...
            console.log("Quantity updated in cart. Updated cart:", updatedCart);
            res.json({
                status: 'success',
    ...
    async emptyCart(req, res) {
        ...
        try {
            ...
            console.log('Cart emptied successfully:', updatedCart);
            res.json({
                status: 'success',
